...
def run_test_factorial():
    ...
    print('Test 5 expected (from oracle):', answer_by_hand)
    print('       actual (from my code): ', answer_from_my_code)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 1
    answer = count_cosines_from(13, 15, 0.35)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(20, 25, 0.1)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(39, 43, 0.75)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 0.995635  # This is APPROXIMATELY the correct answer.
